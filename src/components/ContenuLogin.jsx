	...
	return (
		<div className="contenulogin">
			<main id="corps">
				...
				<article>
					<p class="texte">
					Bienvenue sur notre Utilitaire Textuel pour la Communication (ou plus communément appelé UTC) ! Celui-ci vous permet d'échanger en ligne des messages sur des canaux multi-utilisateurs sous forme de conversations.
					<br />
					<br />
					...
					<br />
					<br />
					Pour débuter votre expérience sur notre plateforme, n'attendez plus et authentifiez-vous sur le bandeau juste à droite !
					</p>
				</article>
			</main>
		</div>
